  ...
  return (
    <div className='flex flex-col border-4 md:p-2'>
        ...
        <div className='flex flex-row items-center justify-start gap-4 p-5 px-5 pt-2 text-2xl md:text-xl'>
            ...
            <button>+</button>
            <button className='text-white bg-red-400 py-3 px-3 rounded md:ml-3 hover:bg-red-700 duration-500 flex items-center justify-center text-sm md:text-xs font-medium md:font-semibold w-auto ml-auto'>Remove Items</button>
        </div>
    </div>
  )
}
