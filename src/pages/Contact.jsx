...
const Contact = () => {
  return (
    <div className='bg-indigo-400 p-12 md:p-20 md:pt-15 flex items-center justify-center'>
      <div className='bg-white w-full md:max-w-xs p-10 rounded-lg'>
        ...
        <form action="#" className='flex flex-col'>
          ...
          <textarea className='border p-2 rounded py-1 mb-10 resize-none placeholder:italic placeholder:text-slate-400' type="textarea" placeholder='Message...' />
          <Button>Send</Button>
        </form>
      </div>
  </div>
