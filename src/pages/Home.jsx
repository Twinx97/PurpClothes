  ...
  return (
    <div>
      <div className='bg-gradient-to-tr from-indigo-900 to-indigo-800 h-96 w-full md:top-0 relative'>
        <img src={bannerImage} className="w-full h-full object-cover absolute mix-blend-overlay" />
        <div className='p-20 px-10 md:px-20 md:py-20 lg:py-30'>
          ...
          <p className='text-white text-3xl font-light mb-10'>The Latest Fashion trends has arrived.</p>
        </div>
      </div>
    </div>
  )
